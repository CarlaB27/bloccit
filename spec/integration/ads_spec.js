    ...
    describe("POST /advertisements/create", () => {
        const options = {
            ...
            form: {
                ...
                description: "Best of Gibson"
            }
        };
        it("should create a new advertisement and redirect", (done) => {
            request.post(options,
                (err, res, body) => {
                    Advertisement.findOne({ where: { title: "Gibson Guitars" } })
                        .then((advertisement) => {
                            expect(res.statusCode).toBe(303);
                            expect(advertisement.title).toBe("Gibson Guitars");
                            expect(advertisement.description).toBe("Best of Gibson");
                            done();
                        })
                        .catch((err) => {
                            console.log(err);
